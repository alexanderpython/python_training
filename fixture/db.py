...
class DbFixture:
    ...
    def get_detail_contact_list(self):
        list = []
        cursor = self.connection.cursor()
        try:
            ...
            for row in cursor:
                ...
                list.append(Contact(id=str(id), firstname=firstname, lastname=lastname, address=address, telephone=home,
                                    telephone2=mobile, telephone3=work, email=email, email2=email2, email3=email3))
        finally:
            cursor.close()
        return list
